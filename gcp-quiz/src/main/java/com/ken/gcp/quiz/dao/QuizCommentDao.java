...
public class QuizCommentDao extends GCPSupportDao {
	...
	public Entity addComment(final QuizComment quizComment) {
		final IncompleteKey key = getKeyFactory().newKey(); // Key will be assigned once written
